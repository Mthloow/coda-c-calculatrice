...
int main() {
	...
	nombre=-1;  // Initialisation de nombre avec -1 pour éviter des bugs.
        ...
        if (nombre < 1 || nombre > 100){// Test si le nombre est bien compris entre 1 et 100.
            ...
            if (nombre == random_number){  // Test si le nombre de l'utilisateur est égale avec le nombre magique.
             ...
             else if (nombre > random_number){  // Test si le nombre de l'utilisateur est supérieur avec le nombre magique. 
